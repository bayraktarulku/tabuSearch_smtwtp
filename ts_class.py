...
test = TS(Path='dataset/instance_10.xlsx', seed = 2012, tabu_tenure=3, Penalization_weight=0.6)
# test = TS(Path='Data_instances/Instance_50.xlsx', seed = 2012, tabu_tenure=6, Penalization_weight=0.8)
